...
_SENSORS: list[_Sensor] = [
    ...
    _Sensor("heiko_setpoint_komfort", "Heiko: plan nastawy wody, blok bieżący (Komfort)", "°C",
            "temperature", "mdi:thermometer"),
    _Sensor("heiko_setpoint_ekonomia", "Heiko: plan nastawy wody, blok bieżący (Ekonomia)", "°C",
            "temperature", "mdi:thermometer"),
    _Sensor("heiko_savings_today_komfort", "Heiko: szac. oszczędność planu 36 h (Komfort)",
            "PLN", "monetary", "mdi:cash-multiple"),
    _Sensor("heiko_savings_today_ekonomia", "Heiko: szac. oszczędność planu 36 h (Ekonomia)",
            "PLN", "monetary", "mdi:cash-multiple"),
    _Sensor("heiko_savings_shift_komfort", "Heiko: w tym z samego przesunięcia (Komfort)",
            "PLN", "monetary", "mdi:swap-horizontal"),
    _Sensor("heiko_savings_shift_ekonomia", "Heiko: w tym z samego przesunięcia (Ekonomia)",
            "PLN", "monetary", "mdi:swap-horizontal"),
    _Sensor("heiko_model_k_loss", "Heiko: model — strata cieplna c (uczona)", "1/h", None,
            "mdi:chart-line"),
    _Sensor("heiko_model_k_gain", "Heiko: model — zysk g (uczony)", "°C/h/kW", None,
            "mdi:chart-line"),
    _Sensor("heiko_model_tau", "Heiko: model — stała czasowa wylewki", "h", None,
            "mdi:timer-sand"),
    _Sensor("heiko_model_rmse", "Heiko: model — błąd prognozy 6 h", "°C", None,
            "mdi:target"),
    _Sensor("heiko_model_source", "Heiko: model — źródło parametrów", None, None,
            "mdi:database-cog"),
    _Sensor("heiko_min_room", "Heiko: najzimniejszy pokój stref dziennych", "°C",
