...
export HEIKO_CURVE_WATER_ENTITIES=$(jq -r '.heiko_curve_water_entities // ""' "$CONFIG")
export HEIKO_WATER_TEMP_ENTITY=$(jq -r '.heiko_water_temp_entity // ""' "$CONFIG")
export HEIKO_WORKING_MODE_ENTITY=$(jq -r '.heiko_working_mode_entity // ""' "$CONFIG")
export HEIKO_BOOTSTRAP_OUTDOOR_ENTITY=$(jq -r '.heiko_bootstrap_outdoor_entity // ""' "$CONFIG")
export HEIKO_WATER_SETPOINT_ENTITY=$(jq -r '.heiko_water_setpoint_entity // ""' "$CONFIG")
export HEIKO_CURVE_SHIFT_ENTITY=$(jq -r '.heiko_curve_shift_entity // ""' "$CONFIG")
export HEIKO_ROOM_TARGET_C=$(jq -r '.heiko_room_target_c // "20.6"' "$CONFIG")
export HEIKO_ROOM_MIN_C=$(jq -r '.heiko_room_min_c // "18.5"' "$CONFIG")
export HEIKO_WATER_MIN_C=$(jq -r '.heiko_water_min_c // "20.0"' "$CONFIG")
export HEIKO_WATER_MAX_C=$(jq -r '.heiko_water_max_c // "32.0"' "$CONFIG")
...
export ATTIC_WINDOW_ENTITIES=$(jq -r '.attic_window_entities // ""' "$CONFIG")
export ATTIC_VACATION_ENTITY=$(jq -r '.attic_vacation_entity // ""' "$CONFIG")
export ATTIC_PAUSE_ENTITY=$(jq -r '.attic_pause_entity // ""' "$CONFIG")
export ATTIC_PRESENCE_ENTITY=$(jq -r '.attic_presence_entity // ""' "$CONFIG")
...
export ATTIC_PREHEAT_MAX_MIN=$(jq -r '.attic_preheat_max_min // "120"' "$CONFIG")
export ATTIC_CYCLE_INTERVAL_MIN=$(jq -r '.attic_cycle_interval_min // "5"' "$CONFIG")
export ATTIC_VACANT_AFTER_MIN=$(jq -r '.attic_vacant_after_min // "60"' "$CONFIG")
...
export COMFORT_MIN_ENTITIES=$(jq -r '.comfort_min_entities // ""' "$CONFIG")
export ADVISOR_LENS=$(jq -r '.advisor_lens // ""' "$CONFIG")
export ADVISOR_NOTIFY_SERVICE=$(jq -r '.advisor_notify_service // ""' "$CONFIG")
export ADVISOR_ANOMALY_ENTITIES=$(jq -r '.advisor_anomaly_entities // ""' "$CONFIG")
export ADVISOR_LINK_PATH=$(jq -r '.advisor_link_path // ""' "$CONFIG")
